...
**Status:** v0.2 — **reviewed 2026-09-10** (D-14 to D-17 added); Phases 1–4 built, capstone seeded (D-19 added); P1-1 and P1-5 built (D-20 added); P1-3 reviewed and built (D-21 to D-24 added). Decided 2026-09-10: PRD first, then build in phases. Feature PRD, child of `prd-clearpath-counseling-ops.md`; the P2 that `prd-clinician-departure.md` deferred by name
...
- **A departure executed while the leaver's supervisor is away** still passes unassigned alerts to that supervisor (departure P0-7), not to their cover. Rare, and deferred with P1-3: supervision coverage routes no alert.
